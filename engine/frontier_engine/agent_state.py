...
class AgentStateStore:
 def __init__(self,database:Path)->None:
  ...
  self.connection.executescript("CREATE TABLE IF NOT EXISTS plans(project_id TEXT PRIMARY KEY, content TEXT NOT NULL);CREATE TABLE IF NOT EXISTS todos(id TEXT PRIMARY KEY,project_id TEXT NOT NULL,text TEXT NOT NULL,state TEXT NOT NULL);CREATE TABLE IF NOT EXISTS memories(id TEXT PRIMARY KEY,project_id TEXT NOT NULL,content TEXT NOT NULL);");self.connection.commit()
