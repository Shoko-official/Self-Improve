...
| Scientific artifacts | partially_verified | Append-only versions, SHA-256 content storage, independent provenance fields, and literal local discovery with latest-version metadata are covered by `engine/tests/test_store.py` |
