...
| French and English UI | partially_verified | The global language selector persists the chosen locale and localizes navigation, surface headings, and primary data-boundary status through tested `src/i18n.ts`; deeper form copy remains English while it is migrated to the same resolver |
