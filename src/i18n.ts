...
const surfaceMessages = {
  en: {
    ...
    projectLedgerDescription: "Projects, instructions, sessions, search, and reasoning profiles persist in the local Shoko's LLM store. Development builds use the source engine; packaged builds use the verified managed engine sidecar.",
  ...
  fr: {
    ...
    projectLedgerDescription: "Les projets, instructions, sessions, recherches et profils de raisonnement sont conservés dans le registre local Shoko's LLM. Le développement utilise le moteur source, les packages utilisent le sidecar managé vérifié.",
...
export function surfaceText(language: Language, key: SurfaceMessageKey): string {
  if (language === "fr") {
    const french: Partial<Record<SurfaceMessageKey, string>> = {
      evidenceReview: "Revue des preuves", exactArtifactFeedback: "Retour exact sur l'artefact", persistentProjectWorkspace: "Espace de travail persistant", localAgent: "Agent local", projectLedger: "Registre des projets", trustBoundary: "Frontière de confiance", developmentEngine: "Moteur de développement", noActiveProject: "Créez d'abord un projet actif", refresh: "Actualiser", save: "Enregistrer", run: "Exécuter", projectLedgerTitle: "Registre des projets indisponible", projectCountOne: "projet local", projectCountMany: "projets locaux", newProjectInstructions: "Nouveau projet et instructions", researchWorkspace: "Espace de recherche", projectInstructions: "Instructions du projet", createProject: "Créer le projet", searchLocalSessions: "Rechercher toutes les sessions locales", sessionTitleLiteral: "Titre exact de session", searchSessions: "Rechercher les sessions", noMatchingSessions: "Aucune session locale ne correspond à cette recherche exacte", noProjects: "Aucun projet local pour le moment", loadingProjectLedger: "Chargement du registre local des projets...", archive: "Archiver", sessionLedger: "REGISTRE DES SESSIONS", loadingSessions: "Chargement des sessions", saveInstructions: "Enregistrer les instructions", newSessionReasoning: "Nouvelle session et effort de raisonnement", initialAnalysis: "Analyse initiale", createSession: "Créer la session", unstar: "Retirer des favoris", star: "Ajouter aux favoris", fork: "Dupliquer", noSessions: "Aucune session dans ce projet", refreshProjectLedger: "Actualiser le registre des projets", reviewer: "Réviseur", openFindingOne: "constat ouvert", openFindingMany: "constats ouverts", noEvidenceGaps: "Aucun manque de preuve enregistré", runEvidenceReview: "Lancer la revue des preuves", annotationDescription: "Les annotations restent attachées à la version d'artefact indiquée. Une version absente est rejetée.", annotationFields: "Version d'artefact, cible, sélecteur et note", artifactVersionId: "Identifiant de version d'artefact", annotation: "Annotation", saveAnnotation: "Enregistrer l'annotation", refreshAnnotations: "Actualiser les annotations", noOpenAnnotations: "Aucune annotation ouverte pour cette version",
    };
    return french[key] ?? surfaceMessages.fr[key];
  }
