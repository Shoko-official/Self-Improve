...
type ArtifactPreview = { artifact_version_id: string; renderer_id: string; renderer_version: string; source_sha256: string; html: string; figure?: ScientificFigureData; warnings?: string[]; execution?: string; resources?: string; sanitizer?: string; };
...
function ArtifactPreviewPanel({ preview }: { preview: ArtifactPreview }) {
  ...
  return <article className="artifact-preview" aria-label="Latest artifact preview">
    ...
    {preview.figure ? <div className="artifact-figure-preview"><ScientificFigureView figure={preview.figure} /></div> : <div className="markdown-body artifact-rendered-html" dangerouslySetInnerHTML={{ __html: preview.html }} />}
