...
function ArtifactWorkspaceSurface({ language }: { language: Language }) {
  ...
  return <><ArtifactsSurface language={language} onInspectVersion={setInspectedVersionId} /><AnnotationSurface language={language} initialVersionId={inspectedVersionId} /></>;
}
